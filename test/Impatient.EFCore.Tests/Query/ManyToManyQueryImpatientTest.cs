...
using Xunit;
using static Impatient.EFCore.Tests.Query.ManyToManyQueryImpatientTest;

namespace Impatient.EFCore.Tests.Query;

public class ManyToManyQueryImpatientTest : ManyToManyQueryRelationalTestBase<Fixture>
{
