...
using Xunit;
using static Impatient.EFCore.Tests.Query.ManyToManyNoTrackingQueryImpatientTest;

namespace Impatient.EFCore.Tests.Query;

public class ManyToManyNoTrackingQueryImpatientTest : ManyToManyNoTrackingQueryRelationalTestBase<Fixture>
{
