...
using Xunit;
using static Impatient.EFCore.Tests.QueryExpressionInterceptionImpatientTest;

namespace Impatient.EFCore.Tests;

public class QueryExpressionInterceptionImpatientTest : QueryExpressionInterceptionTestBase, IClassFixture<Fixture>
{
    public QueryExpressionInterceptionImpatientTest(Fixture fixture) : base(fixture)
    {
    }
