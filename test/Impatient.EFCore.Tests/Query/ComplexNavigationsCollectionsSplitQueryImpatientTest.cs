...
public class ComplexNavigationsCollectionsSplitQueryImpatientTest : ComplexNavigationsCollectionsSplitQueryRelationalTestBase<Fixture>
{
    ...
    public new class Fixture : ComplexNavigationsQueryFixtureBase
    {
