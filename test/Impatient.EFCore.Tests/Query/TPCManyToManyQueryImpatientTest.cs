...
using Xunit;
using static Impatient.EFCore.Tests.Query.TPCManyToManyQueryImpatientTest;

namespace Impatient.EFCore.Tests.Query;

public class TPCManyToManyQueryImpatientTest : TPCManyToManyQueryRelationalTestBase<Fixture>
{
    public TPCManyToManyQueryImpatientTest(Fixture fixture) : base(fixture)
    {
