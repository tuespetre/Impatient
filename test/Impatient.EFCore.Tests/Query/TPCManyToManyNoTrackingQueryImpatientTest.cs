...
using Xunit;
using static Impatient.EFCore.Tests.Query.TPCManyToManyNoTrackingQueryImpatientTest;

namespace Impatient.EFCore.Tests.Query;

public class TPCManyToManyNoTrackingQueryImpatientTest : TPCManyToManyNoTrackingQueryRelationalTestBase<Fixture>
{
