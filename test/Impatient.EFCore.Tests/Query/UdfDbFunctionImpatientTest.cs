...
{
    public class UdfDbFunctionImpatientTest : IClassFixture<UdfDbFunctionImpatientTest.SqlServerUDFFixture>
    {
        public UdfDbFunctionImpatientTest(SqlServerUDFFixture fixture, ITestOutputHelper testOutputHelper)
        {
            Fixture = fixture;
        ...
        private void Scalar_Function_Extension_Method_Static()
        {
            using (var context = CreateContext())
            {
                ...
                AssertSql(
                    @"SELECT COUNT(*)
FROM [Customers] AS [c]
WHERE IsDate([c].[FirstName]) = 0");
            }
        }

        [Fact(Skip = "We don't work with EF Core's custom expression types")]
...
SELECT [dbo].[CustomerOrderCount](@p0)
FROM [Customers] AS [c]");
            }
        }
        ...
        public void Scalar_Function_Anonymous_Type_Select_Correlated_Static()
        {
            using (var context = CreateContext())
            {
                ...
                AssertSql(
                    @"SELECT TOP (2) [c].[LastName] AS [LastName], [dbo].[CustomerOrderCount]([c].[Id]) AS [OrderCount]
FROM [Customers] AS [c]
WHERE [c].[Id] = 1");
            }
        }
        ...
        public void Scalar_Function_Anonymous_Type_Select_Not_Correlated_Static()
        {
            using (var context = CreateContext())
            {
                ...
                AssertSql(
                    @"SELECT TOP (2) [c].[LastName] AS [LastName], [dbo].[CustomerOrderCount](1) AS [OrderCount]
FROM [Customers] AS [c]
WHERE [c].[Id] = 1");
            }
        }
...
SELECT TOP (2) [c].[LastName] AS [LastName], [dbo].[CustomerOrderCount](@p0) AS [OrderCount]
FROM [Customers] AS [c]
WHERE [c].[Id] = @p1");
            }
        }
...
SELECT TOP (2) [c].[LastName] AS [LastName], [dbo].[StarValue](@p0, [dbo].[CustomerOrderCount](@p1)) AS [OrderCount]
FROM [Customers] AS [c]
WHERE [c].[Id] = @p2");
            }
        }
...
WHERE [dbo].[IsTopCustomer]([c].[Id]) = 1");
        ...
        public void Scalar_Function_Where_Not_Correlated_Static()
        {
            using (var context = CreateContext())
            {
                ...
                AssertSql(
                    @"@p0='2000-04-01T00:00:00'

SELECT TOP (2) [c].[Id]
FROM [Customers] AS [c]
WHERE [dbo].[GetCustomerWithMostOrdersAfterDate](@p0) = [c].[Id]");
            }
        }
...
SELECT TOP (2) [c].[Id]
FROM [Customers] AS [c]
WHERE [c].[Id] = [dbo].[GetCustomerWithMostOrdersAfterDate]([dbo].[GetReportingPeriodStartDate](@p0))");
            }
        }
...
WHERE [c].[Id] = 2");
        ...
        public void Scalar_Function_Let_Not_Correlated_Static()
        {
            using (var context = CreateContext())
            {
                ...
                AssertSql(
                    @"SELECT TOP (2) [c].[LastName] AS [LastName], [dbo].[CustomerOrderCount](2) AS [OrderCount]
FROM [Customers] AS [c]
WHERE [c].[Id] = 2");
            }
        }
...
FROM [Orders] AS [o]
LEFT JOIN (
    SELECT 0 AS [$empty], [c_0].[Id] AS [Id], [c_0].[FirstName] AS [FirstName], [c_0].[LastName] AS [LastName]
    FROM [Customers] AS [c_0]
) AS [c] ON [o].[CustomerId] = [c].[Id]
ORDER BY [o].[Id] ASC");
            }
        }
...
WHERE 3 = [dbo].[CustomerOrderCount](ABS([c].[Id]))");
        ...
        private void AssertSql(string expected) => Fixture.AssertSql(expected);
    }
}
